...
const Map = () => {
    ...
    const paginateText = (text, charsPerPage) => {
        const pages = [];
        let currentPage = '';
        ...
        if (currentPage.length + word.length >= charsPerPage) {
            ...
            currentPage += currentPage.length > 0 ? ` ${word}` : word;
        }
        });
    ...
    function buildPage(){
        setPage(0)
        const bodypages = paginateText(Journal[selectedState].body, 300)
        return<p>hello</p>
      };
    ...
    return (    
        ...
        <p>This is a demo of an interactive map website I built for my friend to document his 
        ...
        <Row style={{backgroundColor:'#fff5d7', paddingBottom:'15px', paddingTop:'15px'}}>
            <Col xs={12} md={6}>
            <Row style={{marginBottom:'15px'}}>
                <Card style={{ border:'none', backgroundColor: '#fff5d7',}} className='text-center'>
            ...
            <hr/>
            <Row style={{marginBottom:'15px'}}>
                <Card style={{overflow:'hidden', backgroundColor: '#fff5d7', border:'none'}}>
                <ComposableMap
